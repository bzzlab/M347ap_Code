...
2. MongoDB (lokal oder auf Atlas) ist installiert. Falls nicht vorhanden,
installieren Sie MongoDB, weil die vorliegende Version von TaskManager
erstellt eine Verbindung zur lokalen NoSql-Datenbank.
